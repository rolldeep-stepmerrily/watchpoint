      ...
      <body className="min-h-screen flex flex-col">
        <header className="border-b border-(--color-border) bg-(--color-surface)/80 backdrop-blur sticky top-0 z-10">
          <nav className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-8">
            <Link href="/" className="text-lg font-semibold tracking-tight text-(--color-accent)">
              Watchpoint
            </Link>
            <div className="flex items-center gap-6 text-sm">
              <Link href="/heroes" className="hover:text-(--color-accent-hover)">
                영웅
              </Link>
              <Link href="/patch-notes" className="hover:text-(--color-accent-hover)">
                패치노트
              </Link>
            </div>
          </nav>
